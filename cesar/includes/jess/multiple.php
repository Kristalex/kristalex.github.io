...
?>
        ...
        <form action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="post">
            <div>
                <label><strong>
            Name:</strong><br /><input id="name" type="text" name="Name" required="required" placeholder="Full Name (required)" title="Name is required" tabindex="10" size="44" autofocus />
		</label>
            </div>

            <div>
                <label><strong>
                    Email:</strong><br /><input type="email" name="Email" required="required" placeholder="Email (required)" title="A valid email is required" tabindex="20" size="44" />
		</label>
            </div>
            <!-- below change the HTML to your form elements - only 'Name' & 'Email' (above) are significant -->
            <div>
                <fieldset>
                    <legend><strong>What Programs Are You Interested In?</strong></legend>
            ...
            <div>
                <label>
                    <strong>Comments:</strong><br /><textarea name="Comments" cols="36" rows="4" placeholder="Your comments are important to us!" tabindex="60"></textarea>
		</label>
            </div>
            ...
            <div>
                <fieldset>
                    <legend><strong>Would you like to join our mailing list?</strong>
                    </legend>
            ...
            <div class="g-recaptcha" data-theme="light" data-sitekey="<?=$siteKey;?>" style="transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0;"></div>
            <div>
